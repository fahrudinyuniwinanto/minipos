...
class Jual_byr extends CI_Controller
{
    private $m;
    public function __construct()
    {
        parent::__construct();
        is_logged();
        $this->load->model('Jual_byr_model');
        $this->m = new Jual_byr_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/jual_byr/jual_byr_frm",
        );
    ...
    public function prin()
    {
        ...
        $data = array(
            'h'       => $data->row(),
            'content' => 'backend/jual_byr/jual_byr_print',
        );
