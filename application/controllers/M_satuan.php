...
class M_satuan extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->m = new M_satuan_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/m_satuan/m_satuan_frm",
        );
    ...
    public function prin()
    {
        ...
        $data = array(
            'h' => $data->row(),
            'content' => 'backend/m_satuan/m_satuan_print',
        );
    ...
    public function import()
    {
        ...
        $bpjs = $awm->get_where('data_satuan', [1 => 1])->result();
        foreach ($bpjs as $k => $v) {
            $arr['id'] = $v->satuan;
            $arr['nama_satuan'] = $v->satuan;
            $arr['simbol'] = $v->satuan;
