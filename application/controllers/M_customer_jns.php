...
class M_customer_jns extends CI_Controller {
private $m;
function __construct() {
parent::__construct();
is_logged();
$this->load->model('M_customer_jns_model');
$this->m = new M_customer_jns_model();
}

public function index() {
$data = array(
'content' => "backend/m_customer_jns/m_customer_jns_frm",
);
...
$data = array(
'h' => $data->row(),
'content' => 'backend/m_customer_jns/m_customer_jns_print',
);
