...
class M_group_d extends CI_Controller
{
    private $m;
    function __construct()
    {
        parent::__construct();
        is_logged();
        $this->load->model('M_group_d_model');
        $this->m = new M_group_d_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/m_group_d/m_group_d_frm",
        );
    ...
    public function prin()
    {
        ...
        $data = array(
            'h' => $data->row(),
            'content' => 'backend/m_group_d/m_group_d_print',
        );
