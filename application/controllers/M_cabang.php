...
class M_cabang extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->m = new M_cabang_model();
    }

    public function index()
    {
        $data = array(
            'content' => "backend/m_cabang/m_cabang_frm",
        );
    ...
    public function lookup()
    {
        ...
        $total = $this->db->from($this->m->table)
            ->like('id', $q)
            ->count_all_results();
        $current = $this->db->select("id,nama,alamat,telpon,fax,npwp,cp")
            ->from($this->m->table)
            ->like('id', $q)
    ...
    public function prin()
    {
        ...
        $data = array(
            'h' => $data->row(),
            'content' => 'backend/m_cabang/m_cabang_print',
        );
