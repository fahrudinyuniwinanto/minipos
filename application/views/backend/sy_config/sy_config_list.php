    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('sy_config/read/'.$sy_config->id),'Read','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('sy_config/update/'.$sy_config->id),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('sy_config/delete/'.$sy_config->id),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
