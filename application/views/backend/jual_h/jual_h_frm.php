...
<div class="ibox float-e-margins" ng-show="f.tab=='list'">
    ...
    <div class="ibox-content form-inline">
        ...
        <div class="input-group m-b">
            <input type="date" ng-model="f.startdate" class="form-control input-sm" placeholder="Tanggal Mulai" ng-change="getList()">
        </div>
        <div class="input-group m-b">
            <input type="date" ng-model="f.enddate" class="form-control input-sm" placeholder="Tanggal Selesai" ng-change="getList()">
        </div>
        <div id="div1" class="table-responsive">
            <table ng-table="tableList" show-filter="false" id="tbl" class="table table-condensed table-bordered table-hover" style="white-space: nowrap;">
                <tr ng-repeat="(k,v) in $data" class="pointer" ng-click="read(v.id)" ng-class="v.shift=='PAGI'?'success':'warning'">
                    ...
                    <td title="'No Transaksi'" filter="{no_trs: 'text'}" sortable="'no_trs'"><strong>{{v.no_trs}}</strong></td>
                    ...
                    <td ng-if="f.jenis=='MK'" title="'Terbayar'" filter="{terbayar: 'text'}" sortable="'terbayar'" class="text-right">{{v.terbayar|number}}
                    </td>
                    <td title="'Dicici'" filter="{total: 'text'}" sortable="'total'" class="text-right">
                        <strong>{{v.total|number}}</strong></td>
                </tr>
            </table>
        </div>
    </div>
                    ...
                    getData: function($defer, params) {
                        ...
                        return $http.get(SfService.getUrl('/getList'), {
                            params: {
                                ...
                                q: $scope.f.q,
                                jenis: $scope.f.jenis,
                                startdate: $scope.f.startdate,
                                enddate: $scope.f.enddate,
                            }
                        }).then(function(jdata) {
                            $btn.button('reset');
