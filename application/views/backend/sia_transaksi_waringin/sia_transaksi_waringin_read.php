...
<html>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h2 style="margin-top:0px">Sia_transaksi_waringin Read</h2>
	    ...
	    <tr><td>Jenis Saldo</td><td><?php echo $jenis_saldo; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('sia_transaksi_waringin') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
            </div>
        </div>
    </div>
