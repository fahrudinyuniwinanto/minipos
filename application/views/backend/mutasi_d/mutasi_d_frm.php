    ...
    <div class="ibox-content frmEntry">
        <div class="row">
            <div class="col-sm-4">
                            ...
                            <input type="text" ng-model="h.id_barang" class="form-control input-sm" placeholder="" readonly>
                            <span class="input-group-addon pointer" ng-click="lookup('h_id_barang')">Cari</span>
                        </div>
...
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
        SfService.setUrl("<?=base_url()?>mutasi_d");
        $scope.f = {
            crud: 'c',
            tab: 'list',
            pk: 'id'
