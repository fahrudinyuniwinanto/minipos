        ...
        <div class="row">
            <div class="col-sm-4">
                                                            <label title="id">ID</label>
                                                                ...
                                                                <input type="text" ng-model="h.jenis_customer" class="form-control input-sm">
...
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
        SfService.setUrl("<?=base_url()?>m_customer_jns");
        $scope.f = {
            crud: 'c',
            tab: 'list',
            pk: 'id'
