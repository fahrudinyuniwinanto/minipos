    ...
    <div class="row">
		...
		<th class="text-center">Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo ' | '; 
				echo anchor(site_url('users/update/'.$users->id_user),'Update','class="text-navy"'); 
				echo ' | '; 
				echo anchor(site_url('users/delete/'.$users->id_user),'Delete','class="text-navy" onclick="javascript: return confirm(\'Yakin hapus data?\')"'); 
				?>
			</td>
		</tr>
