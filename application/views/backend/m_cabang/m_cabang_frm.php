        ...
        <div id="div1" class="table-responsive">
            <table ng-table="tableList" show-filter="false" class="table table-condensed table-bordered table-hover"
                ...
                <tr ng-repeat="(k,v) in $data" class="pointer" ng-click="read(v.id)">
                    ...
                    <td title="'Telpon'" filter="{telpon: 'text'}" sortable="'telpon'">{{v.telpon}}</td>
    ...
    <div class="ibox-content frmEntry">
        <div class="row">
            <div class="col-sm-4">
                ...
                <input type="text" ng-model="h.id" class="form-control input-sm" required>
                ...
                <label title="telpon">Telpon</label>
                <input type="text" ng-model="h.telpon" class="form-control input-sm numeric">
                <label title="fax">Fax</label>
                <input type="text" ng-model="h.fax" class="form-control input-sm numeric">
                <label title="npwp">NPWP</label>
                <input type="text" ng-model="h.npwp" class="form-control input-sm">
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
    ...
    SfService.setUrl("<?=base_url()?>m_cabang");
    $scope.f = {
        crud: 'c',
        tab: 'list',
        pk: 'id'
