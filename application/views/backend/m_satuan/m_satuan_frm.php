                ...
                <tr ng-repeat="(k,v) in $data" class="pointer" ng-click="read(v.id)">
                    <td title="'No'">{{k+1}}</td>
                                                                        <td title="'Id'" filter="{id: 'text'}" sortable="'id'">{{v.id}}</td>
                                                                                                <td title="'Nama Satuan'" filter="{nama_satuan: 'text'}" sortable="'nama_satuan'">{{v.nama_satuan}}</td>
                                                                                                <td title="'Simbol'" filter="{simbol: 'text'}" sortable="'simbol'">{{v.simbol}}</td>
                                                                                                                                                                                                                                                                                        </tr>
            </table>
        </div>
    </div>
            ...
            <div class="col-sm-4">
                                                            <label title="id">ID</label>
                                                                <input type="text" ng-model="h.id" class="form-control input-sm">
                                                                                <label title="nama_satuan">Nama Satuan</label>
                                                                <input type="text" ng-model="h.nama_satuan" class="form-control input-sm">
                                                                                <label title="simbol">Simbol</label>
                                                                <input type="text" ng-model="h.simbol" class="form-control input-sm">
                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>
        </div>
    </div>
</div>
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
        SfService.setUrl("<?=base_url()?>m_satuan");
        $scope.f = {
            crud: 'c',
            tab: 'list',
            pk: 'id'
