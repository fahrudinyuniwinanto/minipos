                ...
                <tr ng-repeat="(k,v) in $data" class="pointer" ng-click="read(v.id)">
                    <td title="'No'">{{k+1}}</td>
                                                                        <td title="'Id'" filter="{id: 'text'}" sortable="'id'">{{v.id}}</td>
                                                                                                <td title="'Id Piutang'" filter="{id_piutang: 'text'}" sortable="'id_piutang'">{{v.id_piutang}}</td>
                                                                                                <td title="'Id Jual'" filter="{id_jual: 'text'}" sortable="'id_jual'">{{v.id_jual}}</td>
                                                                                                ...
                                                                                                <td title="'Alokasi'" filter="{alokasi: 'text'}" sortable="'alokasi'">{{v.alokasi}}</td>
                                                                                                <td title="'Allow Pay'" filter="{allow_pay: 'text'}" sortable="'allow_pay'">{{v.allow_pay}}</td>
                                                            </tr>
            </table>
        </div>
    </div>
            ...
            <div class="col-sm-4">
                                                            <label title="id">Id</label>
                                                                <input type="text" ng-model="h.id" class="form-control input-sm">
                                                                                <label title="id_piutang">Id Piutang</label>
                                                                <input type="text" ng-model="h.id_piutang" class="form-control input-sm">
                                                                                <label title="id_jual">Id Jual</label>
                                                                <input type="text" ng-model="h.id_jual" class="form-control input-sm">
                                                                ...
                                                                <input type="text" ng-model="h.tambah_rp" class="form-control input-sm">
                                                                                <label title="alokasi">Alokasi</label>
                                                                <input type="text" ng-model="h.alokasi" class="form-control input-sm">
                                                                                <label title="allow_pay">Allow Pay</label>
                                                                <input type="text" ng-model="h.allow_pay" class="form-control input-sm">
                                                </div>
        </div>
    </div>
</div>
<script>
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
        SfService.setUrl("<?=base_url()?>piutang_d");
        $scope.f = {
            crud: 'c',
            tab: 'list',
            pk: 'id'
