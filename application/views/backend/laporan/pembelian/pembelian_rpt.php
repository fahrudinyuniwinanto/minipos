...
<!doctype html>
<h3>Laporan Pembelian {{f.jenis}}</h3>
<hr>
<div class="">
    <div class="col-md-3">
        <label>Cabang</label>
...
app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http,
    ...
    $scope.cetak = function() {
        ...
        window.open(SfService.getUrl("/prinPembelian?date1=" + $scope.date1 + "&date2=" + $scope
            .date2 + "&bulan=" + $scope.bulan + "&tahun=" + $scope.tahun + "&pilihan=" + $scope
            .pilihan + "&cabang=" + $scope.cabang + "&jenis=" + $scope.f.jenis));
    }
