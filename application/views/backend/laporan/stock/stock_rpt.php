...
<script>
    ...
    app.controller('mainCtrl', ['$scope', '$http', 'NgTableParams', 'SfService', 'FileUploader', function($scope, $http, NgTableParams, SfService, FileUploader) {
        ...
        $scope.cetak = function() {
            ...
            window.open(SfService.getUrl("/prinStock?date1=" + $scope.date1 + "&date2=" + $scope.date2 + "&bulan=" + $scope.bulan + "&tahun=" + $scope.tahun + "&pilihan=" + $scope.pilihan + "&cabang=" + $scope.cabang));
        }
